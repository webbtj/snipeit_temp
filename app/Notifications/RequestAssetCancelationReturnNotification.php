...
class RequestAssetCancelationReturnNotification extends Notification
{
    /**
     * @var
     */
    ...
    public function toSlack()
    {
        ...
        return (new SlackMessage)
            ->content( trans('mail.a_user_canceled_return'))
            ->from($botname)
    ...
    public function toMail()
    {
        ...
        $message = (new MailMessage)->markdown('notifications.markdown.asset-requested',
            [
                ...
                'intro_text'        => trans('mail.a_user_canceled_return'),
            ])
            ->subject(trans('mail.Item_Return_Request_Canceled'));
