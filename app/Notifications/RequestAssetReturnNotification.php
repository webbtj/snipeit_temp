...
class RequestAssetReturnNotification extends Notification
{
    /**
     * @var
     */
    ...
    public function toSlack()
    {
        ...
        return (new SlackMessage)
            ->content(trans('mail.Item_Return_Requested'))
            ->from($botname)
    ...
    public function toMail()
    {
        ...
        $message = (new MailMessage)->markdown('notifications.markdown.asset-requested',
            [
                ...
                'intro_text'        => trans('mail.a_user_requested_return'),
                'qty'           => $this->item_quantity,
            ])
            ->subject(trans('mail.Item_Return_Requested'));
